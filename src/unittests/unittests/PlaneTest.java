...
public class PlaneTest {
    ...
    public void getNormal() {
        ...
        assertEquals("bla bla", 1, plane.getNormal(receivedPoint).length(), 0.00001);
        assertEquals("bla bla", 0, p1.subtract(p2).dotProduct(plane.getNormal(receivedPoint)), 0.00001);
        assertEquals("bla bla", 0, p1.subtract(p3).dotProduct(plane.getNormal(receivedPoint)), 0.00001);
    }
