...
public class RenderTest {
    ...
    public void complexRendering2(){
        ...
        Geometries geometries = new Geometries();
        scene.addGeometry(geometries);
        geometries.add(new Sphere( 50, new Point3D(0, 0, 150),new Color(20,46,1),new Material(0.1,0.2,2)));
        ...
        geometries.add(new Triangle(new Point3D(-100, 0, 149),
                new Point3D(  0, 100, 149),
                new Point3D(-100, 100, 149),new Color(20,77,1),new Material(0.1,0.2,2)));

        geometries.add(new Triangle(new Point3D(-100, 0, 149),
                new Point3D(  0,  -100, 149),
                new Point3D(-100, -100, 149),new Color(20,98,1),new Material(0.1,0.2,2)));
        //scene.addLightSource(new SpotLight( new Color(2,289,43),new Point3D(0,0,0),0.1,0.0001,0.000001,new Vector(0,0,1)));
